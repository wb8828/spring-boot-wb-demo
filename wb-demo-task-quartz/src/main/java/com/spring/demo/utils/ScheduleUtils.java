...
public class ScheduleUtils {
    ...
    public static boolean whiteList(String invokeTarget) {
        ...
        return StrUtil.containsAnyIgnoreCase(beanPackageName, Constants.JOB_WHITELIST_STR) && !StrUtil.containsAnyIgnoreCase(beanPackageName, Constants.JOB_ERROR_STR);
    }
}
