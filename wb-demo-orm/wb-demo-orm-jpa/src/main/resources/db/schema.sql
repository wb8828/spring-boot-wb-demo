DROP TABLE IF EXISTS `test_orm_user`;
CREATE TABLE `test_orm_user` (
...
DROP TABLE IF EXISTS `test_orm_department`;
CREATE TABLE `test_orm_department` (
  `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '主键',
...
DROP TABLE IF EXISTS `test_orm_user_dept`;
CREATE TABLE `test_orm_user_dept` (
  `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '主键',
