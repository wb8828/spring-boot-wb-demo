...
import com.spring.demo.mapper.SysJobMapper;
...
public class SysJobServiceImpl implements ISysJobService {
     ...
     */
    @Override
    public IPage<SysJob> selectJobListByPage(SysJob job) {
        IPage<SysJob> page = new Page<SysJob>(job.getPageNum(), job.getPageSize());
...
//    @Transactional(rollbackFor = Exception.class)
     ...
     */
    @Override
//    @Transactijonal(rollbackFor = Exception.class)
