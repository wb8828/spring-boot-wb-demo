...
//            else  cLen--;
     ...
     * @throws Exception
     */
    public void exportWebExcel(HttpServletResponse response, List<Column> listTpamscolumn, List<T> datas, boolean flag, boolean rowFlag) throws Exception {
        response.setContentType("application/vnd.ms-excel");
        response.setCharacterEncoding("utf-8");
        splitDataToSheets(datas, listTpamscolumn, flag, rowFlag);
        saveWeb(this.workbook, response.getOutputStream());
    }
     ...
     * @throws Exception
     */
    public void writeSheet(HSSFSheet sheet, List<T> data, List<Column> listTpamscolumn, boolean flag, boolean rowFlag) throws Exception {
     ...
     * @return
     */
    private void saveWeb(HSSFWorkbook workbook, OutputStream outputStream) {
        try {
...
//========上部分是导出excel的使用（生成excel），下部分是解析excel，excel导入==================================================================================================================================
