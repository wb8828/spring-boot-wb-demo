...
import static com.spring.demo.utils.SqlUtil.escapeOrderBySql;
...
public class PageUtils extends PageHelper {
     ...
     * 设置请求排序数据
     */
    public static void startOrderBy(String orderBy) {
        if (orderBy == null || "".equals(orderBy.trim())) {
            return;
        }
        String escapeOrderBySql = escapeOrderBySql(orderBy);
        PageHelper.orderBy(escapeOrderBySql);
    }
