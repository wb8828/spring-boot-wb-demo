...
import com.spring.demo.generator.config.GenConfig;
...
public class GenUtils {
     ...
     * 初始化表信息
     */
    public static void initTable(GenTable genTable, String operName, CreateCodeGenConfig createCodeGenConfig) {
        genTable.setClassName(convertClassName(genTable.getTableName()));
        if (createCodeGenConfig == null) {
...
//            genTable.setCreateBy(operName);
     ...
     * 初始化表信息
     */
    public static void initTableCustom(GenTable genTable, String operName, String packageName, String moduleName, String author) {
        genTable.setClassName(convertClassName(genTable.getTableName()));
        genTable.setPackageName(StringUtils.isNotBlank(packageName) ? packageName : GenConfig.getPackageName());
        genTable.setModuleName(StringUtils.isNotBlank(moduleName) ? moduleName : getModuleName(GenConfig.getPackageName()));
        genTable.setBusinessName(getBusinessName(genTable.getTableName()));
        genTable.setFunctionName(replaceText(genTable.getTableComment()));
