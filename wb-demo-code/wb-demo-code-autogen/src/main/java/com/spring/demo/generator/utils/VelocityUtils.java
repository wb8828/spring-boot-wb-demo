package com.spring.demo.generator.utils;
...
//    private static final String PROJECT_PATH = "main/java";
     ...
     * @return 模板列表
     */
    public static VelocityContext prepareContext(GenTable genTable, GenGlobalConfig config) {
        ...
        // 是否开启openPageHelper
        velocityContext.put("openPageHelper", config.getOpenPageHelper());
        // 是否开启lombok
        velocityContext.put("openLombok", config.getOpenLombok());
        // 是否开启MybatisPlus
        velocityContext.put("openMybatisPlus",  config.getOpenMybatisPlus());
        // 是否配置BaseEntity
        velocityContext.put("openBaseEntity", StringUtils.isNotEmpty(config.getOpenBaseEntity()));
        velocityContext.put("baseEntityName", org.apache.commons.lang3.StringUtils.substringAfterLast(config.getOpenBaseEntity(), "."));
        velocityContext.put("baseEntityWay", org.apache.commons.lang3.StringUtils.substringBeforeLast(config.getOpenBaseEntity(), "."));
        // 是否配置BaseController
        velocityContext.put("openBaseController", StringUtils.isNotEmpty(config.getOpenBaseController()));
        velocityContext.put("baseControllerName", org.apache.commons.lang3.StringUtils.substringAfterLast(config.getOpenBaseController(), "."));
        velocityContext.put("baseControllerWay", org.apache.commons.lang3.StringUtils.substringBeforeLast(config.getOpenBaseController(), "."));
        // 统一返回响应实体类
        velocityContext.put("openUnifyAjaxResult", StringUtils.isNotEmpty(config.getUnifyAjaxResult()));
        velocityContext.put("unifyAjaxResultName", org.apache.commons.lang3.StringUtils.substringAfterLast(config.getUnifyAjaxResult(), "."));
        velocityContext.put("unifyAjaxResultWay", org.apache.commons.lang3.StringUtils.substringBeforeLast(config.getUnifyAjaxResult(), "."));
...
//        String mybatisPath = MYBATIS_PATH + "/" + moduleName;
        ...
        if (template.contains("sub-domain.java.vm") && org.apache.commons.lang3.StringUtils.equals(GenConstants.TPL_SUB, genTable.getTplCategory())) {
    ...
    public static String getParentMenuId(JSONObject paramsObj) {
        if (paramsObj != null && paramsObj.containsKey(GenConstants.PARENT_MENU_ID)
    ...
    public static String getTreecode(JSONObject paramsObj) {
        if (paramsObj.containsKey(GenConstants.TREE_CODE)) {
            return StrUtils.toCamelCase(paramsObj.getString(GenConstants.TREE_CODE));
        }
    ...
    public static String getTreeParentCode(JSONObject paramsObj) {
        if (paramsObj.containsKey(GenConstants.TREE_PARENT_CODE)) {
            return StrUtils.toCamelCase(paramsObj.getString(GenConstants.TREE_PARENT_CODE));
        }
        return org.apache.commons.lang3.StringUtils.EMPTY;
    }
    ...
    public static String getTreeName(JSONObject paramsObj) {
        if (paramsObj.containsKey(GenConstants.TREE_NAME)) {
            return StrUtils.toCamelCase(paramsObj.getString(GenConstants.TREE_NAME));
        }
        return org.apache.commons.lang3.StringUtils.EMPTY;
    }
